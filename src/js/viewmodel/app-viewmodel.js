...
(function(global) {
  ...
  global.app.AppViewModel = function() {
    var self = this;
    ...
    self.mapViewModel = new global.app.MapViewModel('map-canvas');
    ...
    self.init = function() {
      return $.getJSON('places.json').then(function(json) {
          var mappedPlaces = $.map(json, function(data) {
            return new global.app.Place(data);
          });
  ...
  $(function() {
    var app = new global.app.AppViewModel();
